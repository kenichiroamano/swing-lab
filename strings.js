...
const STR = {
  ...
  d: {
    ...
    'grip.stance.caption':  { ja:'ゴールドの線が示すのは、向き・ボールの位置・前傾です。', en:'The gold lines point to alignment, ball position, and forward tilt.' },
    'grip.stance.checkTitle':{ ja:'立ち方を見る、3つのポイント。',  en:'Three points for the stance.' },
    'grip.stance.1.title':  { ja:'向き',                         en:'Alignment' },
    'grip.stance.1.body':   { ja:'目標の少し左へ伸びる、2本の平行なレールをイメージします。肩・腰・つま先を、そのラインに揃えます。狙いより右を向きやすいので、最後に確かめます。', en:'Picture two parallel rails running just left of the target. Match your shoulders, hips, and toes to that line. It tends to drift right of the target, so check it last.' },
    'grip.stance.2.title':  { ja:'ボールの位置',                  en:'Ball position' },
    'grip.stance.2.body':   { ja:'アプローチでは、ボールは両足の真ん中が目安です。', en:'For the pitch, the ball sits about midway between your feet.' },
    'grip.stance.3.title':  { ja:'前傾と重心',                    en:'Tilt and balance' },
    'grip.stance.3.body':   { ja:'背すじを保ったまま、股関節から前へ傾けます。土踏まずに均等に乗る、猫背でも棒立ちでもない中間です。', en:'Keep your spine long and tilt forward from the hips. Weight even over the arches — neither hunched nor standing tall.' },
    'grip.stance.note':     { ja:'これらも目安です。向きの確認だけは、毎回ていねいに。', en:'Guidelines too — just take care to check your alignment every time.' },
