...
const STR = {
  ...
  d: {
    ...
    'grip.intro':           { ja:'クラブを握る、その一点から整えます。<br>ここでは測りません。お手本を見て、<br>ご自身の手元と見比べてください。', en:'Begin with how you hold the club.<br>Nothing is measured here — look at<br>the model and compare your own hands.' },
