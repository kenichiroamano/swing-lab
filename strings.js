...
const STR = {
  ...
  d: {
    ...
    'grip.stance.caption':  { ja:'足元から見た目安です。ゴールドの線は、足幅・体重のかけ方・ボールを置く位置を示します。全身のお手本映像は準備中です。', en:'A guide seen from the feet — the gold lines mark stance width, weight, and ball position. Full-body model footage is coming soon.' },
