...
const STR = {
  ...
  d: {
    ...
    'grip.show.placeholder':{ ja:'実写の写真・動画を準備中です。',   en:'Photography and video coming soon.' },
    ...
    'grip.stance.viewFoot': { ja:'足元から',                     en:'From the feet' },
    'grip.stance.caption':  { ja:'正面と足元、2つのお手本の図です。ゴールドの線は、足幅・体重のかけ方・ボールを置く位置の目安を示します。', en:'Two model views — front and feet. The gold lines show the rough guides for stance width, weight, and where the ball would sit.' },
